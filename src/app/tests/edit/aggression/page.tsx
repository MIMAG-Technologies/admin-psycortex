...
const getQuestions = async () => {
    try {
        const response = await axios.get(`${base_url}/edits/aggression/get_questions.php`);
...
const getInterpretations = async () => {
    try {
        const response = await axios.get(`${base_url}/edits/aggression/get_interpretations.php`);
...
const updateQuestions = async (questions: Question[]) => {
    try {
        const response = await axios.post(`${base_url}/edits/aggression/set_questions.php`, questions);
...
const updateInterpretations = async (interpretations: Interpretation[]) => {
    try {
        const response = await axios.post(`${base_url}/edits/aggression/set_interpretations.php`, interpretations);
        return response.data;
    } catch (error) {
...
export default function AggressionEditingPage() {
