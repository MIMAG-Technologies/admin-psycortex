...
export default function BaiEditingPage() {
    ...
    const getInterpretations = async () => {
        try {
            const response = await axios.get(`${base_url}/edits/bai/get_interpretations.php`);
    ...
    const updateQuestions = async (questions: Question[]) => {
        try {
            const response = await axios.post(`${base_url}/edits/bai/set_questions.php`, questions);
    ...
    const updateInterpretations = async (interpretations: Interpretation[]) => {
        try {
            const response = await axios.post(`${base_url}/edits/bai/set_interpretations.php`, interpretations);
            return response.data;
        } catch (error) {
    ...
    return (
        <div className="container mx-auto p-6 max-w-7xl">
            <h1 className="text-3xl font-bold mb-8 text-primary">
                Beck Anxiety Inventory (BAI) Management
            </h1>
            ...
            <ConfirmationModal
                ...
                description=""
                testName="Beck Anxiety Inventory (BAI)"
