...
const SCAT_OPTIONS = ["No", "Yes"];
const SCAT_SCORES = [0, 1];

const getQuestions = async () => {
    try {
        const response = await axios.get(`${base_url}/edits/scat/get_questions.php`);
...
const getInterpretations = async () => {
    try {
        const response = await axios.get(`${base_url}/edits/scat/get_interpretations.php`);
...
const updateQuestions = async (questions: Question[]) => {
    try {
        const response = await axios.post(`${base_url}/edits/scat/set_questions.php`, questions);
...
const updateInterpretations = async (interpretations: Interpretation[]) => {
    try {
        const response = await axios.post(`${base_url}/edits/scat/set_interpretations.php`, interpretations);
        return response.data;
    } catch (error) {
...
export default function ScatEditPage() {
                                ...
                                <div className="flex items-start gap-6">
                                    ...
                                    <div className="flex-1 space-y-4">
                                        ...
                                        <div className="space-y-2 mt-4">
                                            ...
                                            {SCAT_OPTIONS.map((option, optionIndex) => (
