...
const SCHIZOPHRENIA_OPTIONS = ["Yes", "No"];
const SCHIZOPHRENIA_SCORES = [1, 2];

const getQuestions = async () => {
    try {
        const response = await axios.get(`${base_url}/edits/schizophrenia/get_questions.php`);
...
const getInterpretations = async () => {
    try {
        const response = await axios.get(`${base_url}/edits/schizophrenia/get_interpretations.php`);
...
const updateQuestions = async (questions: Question[]) => {
    try {
        const response = await axios.post(`${base_url}/edits/schizophrenia/set_questions.php`, questions);
...
const updateInterpretations = async (interpretations: Interpretation[]) => {
    try {
        const response = await axios.post(`${base_url}/edits/schizophrenia/set_interpretations.php`, interpretations);
        return response.data;
    } catch (error) {
...
export default function SchizophreniaEditPage() {
                                        ...
                                        <div className="space-y-2 mt-4">
                                            <div className="flex justify-between items-center">
                                                ...
                                                <div className="text-xs text-muted-foreground">
                                                    Fixed Scoring: Yes=1, No=2
                                                </div>
                                            </div>
                                            {SCHIZOPHRENIA_OPTIONS.map((option, optionIndex) => (
                                                <div key={optionIndex} className="flex gap-2 items-start">
                                                    <div className="bg-muted-foreground text-white font-medium rounded-full w-8 h-8 flex items-center justify-center shrink-0 text-xs">
                                                        {SCHIZOPHRENIA_SCORES[optionIndex]}
                                                    </div>
